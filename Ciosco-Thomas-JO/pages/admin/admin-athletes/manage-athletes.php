...
<body>
    ...
    <main>
        ...
        try {
            ...
            $query = "SELECT a.id_athlete, a.nom_athlete, a.prenom_athlete, p.nom_pays, g.nom_genre 
                      FROM ATHLETE a
            ...
            if ($statement->rowCount() > 0) {
                echo "<table><tr><th>Nom</th><th>Prénom</th><th>Nationalité</th><th>Genre</th><th>Modifier</th><th>Supprimer</th></tr>";
