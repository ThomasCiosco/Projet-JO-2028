...
<body>
    ...
    <main>
        ...
        try {
            ...
            $query = "SELECT id_utilisateur, nom_utilisateur, prenom_utilisateur, login FROM UTILISATEUR ORDER BY nom_utilisateur";
            $statement = $connexion->prepare($query);
            $statement->execute();

            // Vérifier s'il y a des résultats
            if ($statement->rowCount() > 0) {
                echo "<table><tr><th>ID</th><th>Nom</th><th>Prénom</th><th>Login</th><th>Modifier</th><th>Supprimer</th></tr>";
