...
<head>
    ...
    <title>Gestion des Places - Jeux Olympiques - Los Angeles 2028</title>
</head>
...
<body>
    ...
    <main>
        ...
        <div class="action-buttons">
            <button onclick="openAddPlaceForm()">Ajouter une Place</button>
        </div>

        <!-- Tableau des places -->
        <?php
        try {
            // Requête pour récupérer la liste des places depuis la base de données
